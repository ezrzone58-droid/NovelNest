...
st.markdown(
    ...
    /* =====================================================
       FIX keyboard_double_arrow_left
       ===================================================== */

    /*
       Streamlit menggunakan Material Icons.
       Pada beberapa versi Streamlit, nama ikon
       dapat muncul sebagai teks:

       keyboard_double_arrow_left

       Bagian berikut menyembunyikan teks/icon tersebut
       tanpa menghilangkan fungsi tombol sidebar.
    */
    ...
    /* Jika nama ikon muncul sebagai teks biasa */
    ...
    /* Tetap membuat tombol collapse bisa diklik */
